    ...
    return (
        <div style={{ marginLeft: '20px', width: '300px', position: 'fixed', zIndex: 1, top: '50%', marginTop: '-200px', height: '100vh' }}>
            <Paper sx={{ width: '300px' }} elevation={1}>
                ...
                <SelectUsage selectTitle={"Сортировать по:"} selectArr={selectArr} />
                ...
                <Box sx={{ flexGrow: 1 }} />
                <Pagination sx={{ height: '80px', display: 'flex', justifyContent: 'center', alignItems: 'center' }} size="medium" color="primary" count={5} />
            </Paper>
